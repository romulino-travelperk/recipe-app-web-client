# Django Rest Framework Recipes APP // front-end
...
For this to work, you need the server application, which can be found at:
https://github.com/romulino-travelperk/recipe-app-api
# How to run
